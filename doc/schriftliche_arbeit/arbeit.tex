...
Ich nutzte den Sortieralgorithmus Quicksort als Beispiel und implementierte viele optimierte Versionen dieser
...
Für mein Projekt nutze ich meinen Desktop PC (Linux) zum Implementieren und Ausführen der Programme.
...
Ich probierte dabei einfach herum nach dem Prinzip \textit{Trial and Error} und schaute, was
...
vor. Dies tat ich auch, weil mich interessierte, wie schnell die naivste
